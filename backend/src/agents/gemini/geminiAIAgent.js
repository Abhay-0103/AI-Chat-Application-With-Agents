...
const geminiResponseHandler_1 = require("/Users/Abhay Singh/Projects/AIChat/backend/src/agents/gemini/geminiResponseHandler");
class OpenAIAgent {
...
Your goal is to provide accurate, current, and helpful written content. Failure to use web search for recent topics will result in an incorrect answer.`;
        ...
        this.handleMessage = async (e) => {
            ...
            const handler = new geminiResponseHandler_1.OpenAIResponseHandler(this.openai, this.openAiThread, run, this.chatClient, this.channel, channelMessage, () => this.removeHandler(handler));
...
//# sourceMappingURL=geminiAIAgent.js.map